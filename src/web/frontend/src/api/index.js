...
export const portalUsersApi = {
  ...
  adjustBalance: (id, data) => api.post(`/portal-users/${id}/balance/adjust`, data),
...
export const systemApi = {
  ...
  getDeviceLimits: () => api.get('/system/device-limits'),
  updateDeviceLimits: (data) => api.post('/system/device-limits', data),
  getSubscriptionSettings: () => api.get('/system/subscription-settings'),
  updateSubscriptionSettings: (data) => api.post('/system/subscription-settings', data),
