...
- They're on the free tier — only NOWPayments is visible. [Upgrade your Flirexa license](https://flirexa.biz/#pricing) to unlock all providers.
...
- First check the webhook arrived: `journalctl -u vpnmanager-api -n 200 | grep -iE 'webhook|<provider>'`
